...
APPLIANCE_FUNCTIONS = {
    ...
    "manage_recipe": {"method": "POST", "path": "/api/v1/manageRecipe/{said}"},
    "send_ioc_recipe": {"method": "POST", "path": "/api/v1/send/iocrecipe/{said}"},
    "cook_recipe": {"method": "POST", "path": "/api/v2/cookRecipe/{said}"},
}
